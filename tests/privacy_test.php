...
/**
 * Base class for unit tests for enrol_metagroup.
 *
...
use enrol_metagroup\privacy\provider;

/**
 * Unit tests for the enrol_metagroup implementation of the privacy API.
 *
 * @copyright  2018 Carlos Escobedo <carlos@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class enrol_metagroup_privacy_testcase extends \core_privacy\tests\provider_testcase {

    /**
     * Enable enrol_metagroup plugin.
     */
    ...
    public function test_get_contexts_for_userid() {
        ...
        $this->enable_plugin();
        $metagroupplugin->add_instance($course1, array('customint1' => $course2->id, 'customint2' => $group1->id));
    ...
    public function test_export_user_data() {
        ...
        $this->setUser($user1);
        $contextlist = provider::get_contexts_for_userid($user1->id);
        $approvedcontextlist = new approved_contextlist($user1, 'enrol_metagroup', $contextlist->get_contextids());
        ...
        foreach ($contextlist as $context) {
            ...
            if ($context->contextlevel == CONTEXT_COURSE) {
                ...
                // User1 only belongs to group1 via enrol_metagroup.
    ...
    public function test_delete_data_for_user() {
        ...
        $approvedcontextlist = new \core_privacy\tests\request\approved_contextlist($user1, 'enrol_metagroup',
                [$coursecontext1->id]);
    ...
    public function test_delete_data_for_users() {
        ...
        $approveduserlist = new \core_privacy\local\request\approved_userlist($coursecontext1, 'enrol_metagroup',
                [$user1->id, $user2->id]);
    ...
    public function test_get_users_in_context() {
        ...
        $userlist = new \core_privacy\local\request\userlist($context, 'enrol_metagroup');
        \enrol_metagroup\privacy\provider::get_users_in_context($userlist);
